...
def draw_circles1():
    ...
    for k in range(21):
        circlebois = rg.Circle(rg.Point(200, 200), k * 10)
        circlebois.attach_to(window)
    window.render()
...
def draw_cosines_and_sines():
    ...
    window = rg.RoseWindow(width=400, height=400)
    for k in range(101):
        ben = rg.Circle(rg.Point(200 + 80 * math.cos(k), 200 + 80 * math.sin(k)), 10)
